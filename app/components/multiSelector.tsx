...
const people = [
  ...
  { id: 8, name: "Soorya" },
  { id: 9, name: "Chinju" },
  { id: 10, name: "Riza Rahmath" },
  { id: 11, name: "Gouri Nandana" },
  { id: 12, name: "Shamil" },
];
    ...
    <div className="w-full">
      ...
      <Combobox value={selectedPeople} onChange={setSelectedPeople} multiple>
        <div className="relative">
          <div className="relative w-full cursor-default overflow-hidden rounded-xl border border-blue-300 bg-white text-left shadow-sm focus-within:ring-2 focus-within:ring-blue-500 sm:text-sm">
            <Combobox.Input
              className="w-full border-none py-3 pl-3 pr-10 leading-5 text-gray-900 focus:ring-0 outline-none"
              displayValue={(people: typeof selectedPeople) =>
